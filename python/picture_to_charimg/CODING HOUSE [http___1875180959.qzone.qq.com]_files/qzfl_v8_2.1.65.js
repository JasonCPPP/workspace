(window.constructQZFL = function() {
      ...
      if (document.getBoxObjectFor || typeof window.mozInnerScreenX != "undefined") {
        ...
        if (!navigator.taintEnabled) {
          ...
          if ((m = /Chrome.(\d+\.\d+)/i.exec(agent)) || window.chrome) {
            ...
            if ((m = /Version.(\d+\.\d+)/i.exec(agent)) || window.safariHandler) {
  ...
  QZFL.event = {KEYS:{BACKSPACE:8, TAB:9, RETURN:13, ESC:27, SPACE:32, LEFT:37, UP:38, RIGHT:39, DOWN:40, DELETE:46}, _eventListDictionary:{}, _fnSeqUID:0, _objSeqUID:0, addEvent:function(obj, eventType, fn, argArray) {
    ...
    var eventData, handler, handlerObj, handlerArray, delegateType, res = false, E = QZFL.event;
    ...
    var eventData, handlerArray, delegateType, E = QZFL.event, len;
    eventData = E._eventListDictionary[(delegateDom || {}).eventsListUID];
    if (!eventData) {
      return;
    }
  ...
  QZFL.event.delegate._quickParse = function(selector) {
    var REG = /^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/, quick = REG.exec(selector);
    if (quick) {
  ...
  QZFL.object.each({"mouseenter":"mouseover", "mouseleave":"mouseout"}, function(delegateType, origType) {
    QZFL.event.delegate._specialEvent[origType] = {"delegateType":delegateType, "handler":function(event, handlerObj) {
      var target = this, relatedTarget = QZFL.event.getRelatedTarget(event);
  ...
  QZFL.event.delegate._dispatch = function(event) {
    var E = QZFL.event, event = E.getEvent(event), type = event.type, eventData, handlerArray, hit, curDom, specialHandler, selector;
  ...
  cut:/[\x00-\xFF]/, getRealLen:{r0:/[^\x00-\xFF]/g, r1:/[\x00-\xFF]/g}, format:/\{([\d\w\.]+)\}/g}, commonReplace:function(s, p, r) {
    ...
    function _bootStrap() {
      if (QZFL.event.onDomReady.isReady) {
        ...
        if (document.addEventListener) {
          ...
          document.write('<script onreadystatechange="if(this.readyState==\'complete\'){this.parentNode.removeChild(this);QZFL.pageEvents._onloadHook();}" defer="defer" src="' + src + '">\x3c/script>');
        }
      }
  ...
  QZFL.string.timeFormatString._map = {y:["getYear", 31104E6], Y:["getFullYear", 31104E6, "\u5e74\u524d"], M:["getMonth", 2592E6, "\u4e2a\u6708\u524d"], d:["getDate", 864E5, "\u5929\u524d"], h:["getHours", 36E5, "\u5c0f\u65f6\u524d"], m:["getMinutes", 6E4, "\u5206\u949f\u524d"], s:["getSeconds", 1E3, "\u79d2\u524d"]};
        ...
        if (speedUpMatch) {
          if (context.nodeType === 1 || context.nodeType === 9) {
            if (speedUpMatch[1]) {
              ...
              if (speedUpMatch[2] || speedUpMatch[4] && speedUpMatch[5]) {
  ...
  QZFL.effect = {off:0, mode:[], init:function() {
    var classArray = [["webkit", "WebkitTransition"], ["firefox", "MozTransition"], ["opera", "OTransition"], ["ie", "msTransition"]], ua = QZFL.userAgent, agent = "", cName = "";
    ...
    QZFL.effect.run(elem, {opacity:1}, QZFL.object.extend(opts, {duration:duration || 1E3, start:function() {
    ...
    QZFL.effect.run(elem, {opacity:0}, QZFL.object.extend(opts, {duration:duration || 1E3, complete:function() {
    ...
    if (attrs) {
      ...
      o.run(elem, attrs, _obj.extend(opts, {duration:duration || 1E3, start:function() {
    ...
    if (attrs) {
      ...
      complete = opts.complete || QZFL.emptyFn;
      d.setStyle(elem, "display", "");
      o.run(elem, toValue, _obj.extend(opts, {duration:duration || 1E3, complete:function() {
        d.setStyle(elem, "display", "none");
        _obj.each(attrs, function(v, i) {
          d.setStyle(elem, i, v);
        });
  ...
  QZFL.cssTransfrom.prototype = {init:function() {
    var map = [["webkit", "-webkit-transition", "WebkitTransition", "webkitTransitionEnd", "WebkitTransform"], ["firefox", "-moz-transition", "MozTransition", "transitionend", "MozTransform"], ["opera", "-o-transition", "OTransition", "oTransitionEnd", "OTransform"], ["ie", "-ms-transition", "msTransition", "MSTransitionEnd", "msTransform"]], tiClassPrefix, tiStyleName, tiEvtName, tfStyleName, ua = QZFL.userAgent, proto;
  ...
  var _autoXSS = function() {
    ...
    var _XSS = {go:function(item) {
      var rs = item;
      if (!item) {
        return rs;
      }
      var itemType = typeof item, itemObjType;
      if (itemType === "string") {
        rs = this.filter(item);
      } else {
        if (itemType === "object") {
  ...
  (function() {
    var def = {onload:function() {
    }, onprogress:function() {
    }, timeout:3E3, onSuccess:function() {
    }, onError:function() {
    }, onerror:function() {
    }, method:"get", processText:null, instance:null, headers:{"X-Real-Url":""}}, extend = QZFL.object.extend, cdm = location.host, supportlv2 = (QZFL.userAgent.ie > 9 || window.XMLHttpRequest) && "withCredentials" in new XMLHttpRequest;
    ...
    function reportSSLInfo(sslinfo, options) {
      ...
      if (window.haboStat) {
        if (connectionNum == 1) {
          window.haboStat({commandid:"ssl_session_reused", stime:1E3, resultcode:isSessionReused ? 0 : 1, touin:window.g_iLoginUin || 0, frequency:1});
        }
        window.haboStat({commandid:"tcp_conn_reused", stime:1E3, resultcode:connectionNum > 1 ? 0 : 1, touin:window.g_iLoginUin || 0, frequency:1});
      }
    }
        ...
        xhr.onreadystatechange = function() {
          ...
          if (this.readyState == 4) {
            if (this.status == 200) {
              ...
              if (o.code != 0) {
                errcodeReport({code:o.code, cgi:url, pathname:location.pathname});
              }
            } else {
              if (this.status > 400) {
                th.endTime = +new Date;
                ...
                errcodeReport({code:this.status, cgi:url, pathname:location.pathname});
              }
            }
          }
    ...
    QZFL.ajaxGet = function(url, data, opt) {
      ...
      opt = extend({}, def, typeof opt == "function" ? {onload:opt} : opt || {});
      ajaxRequest(url, data, extend(opt, {method:"get", processText:function(str) {
  ...
  QZFL.FormSender.prototype.send = function() {
    ...
    var host = win.location.host, cookieflag = win.QZFL.cookie.get("blabla") == "dynamic", extend = QZFL.object.extend;
    return function() {
      this.startTime = +new Date;
      var isspeedup = cookieflag && /(?:^user\.(s\d\.)?|\d{5,}\.|rc\.)qzone\.qq\.com/.test(host), realurl = this.uri, ajaxurl = realurl, path, tmplURI, canUseXHR = win.QZFL.config.canUseXHR2;
      if (this.charset == "utf-8") {
        if (ua.chrome && (win.QZFL && win.QZFL.FormSender)) {
          ...
          this.speedup = 1;
          var th = this;
          return this.type = "xhr", win.QZFL.ajaxPost(targetUrl, data, {onload:function(rsp) {
            try {
            ...
            th.endTime = +new Date;
            th.onSuccess(rsp);
          }, instance:this, headers:isspeedup ? {"X-Real-Url":realurl} : {}}), this.postTime = +new Date;
        }
      }
      if (this._sender === null || this._sender === void 0) {
        ...
        sender.callback = function(th) {
          return function() {
            ...
            if (arguments && arguments[0].code !== 0) {
              errcodeReport({code:arguments[0].code, cgi:th.uri, pathname:location.pathname});
            }
          };
        }(this);
        var errcallback = function(th) {
          ...
          return function() {
            ...
            errcodeReport({code:502, cgi:th.uri, pathname:location.pathname});
          };
        }(this);
      ...
      if (!this.instanceForm) {
        ...
        ifrHTML = ifrHTML + '<script type="text/javascript">' + ((ie || ff) && 'document.charset="' + t.charset + '"' || "") + ';document.domain="' + document.domain + '";frameElement.submited=void(0);frameElement.state="sending";\x3c/script></head><body>';
  ...
  QZFL.JSONGetter.pluginsPool = {"srcStringHandler":[], "onErrorHandler":[], "onRequestComplete":[], "onRequestTimeout":[]};
  QZFL.JSONGetter._pluginsRunner = function(pType, data) {
    var _s = QZFL.JSONGetter, l = _s.pluginsPool[pType], t = data, re, len;
    if (l && (len = l.length)) {
      for (var i = 0;i < len;++i) {
        if (typeof l[i] == "function") {
          re = l[i](t);
  ...
  QZFL.JSONGetter.prototype.send = function(callbackFnName) {
    ...
    var win = QZFL.win, host = win.location.host, cookieflag = false, extend = QZFL.object.extend;
    var isspeedup = cookieflag && /(?:^user\.(s\d\.)?|\d{5,}\.|rc\.)qzone\.qq\.com/.test(host), realurl = da + function(oriurl) {
    ...
    }(da), tmplURI, path, ajaxurl = isspeedup ? "http://" + host + "/p" : realurl;
    if (this._charset == "utf-8" && (ua.chrome && (window.QZFL && (QZFL.JSONGetter && QZFL.config.xhrGetReqProxyEnable(da))))) {
      ...
      this.speedup = 1;
      return win.QZFL.ajaxGet(ajaxurl, null, {onload:function(th) {
        return function() {
          th._waiting = false;
          try {
            th._sslinfo = this.getResponseHeader("x-stgw-ssl-info") || "";
      ...
      }(this), instance:this, headers:isspeedup ? {"X-Real-Url":realurl} : {}}), this.postTime = +new Date;
    }
    if (QZFL.userAgent.ie && ((typeof document.documentMode == "undefined" || document.documentMode < 10) && !(QZFL.userAgent.beta && navigator.appVersion.indexOf("Trident/4.0") > -1))) {
      ...
      node.onerror = function() {
        this.onerror = null;
        _ecb();
        QZFL.errcodeReport({code:502, cgi:this.src || "", pathname:location.pathname});
      };
      node.src = realurl;
  ...
  QZFL.getParameter = function(url, name) {
    var r = new RegExp("(\\?|#|&)" + name + "=([^&#]*)(&|#|$)"), m = url.match(r);
    return!m ? "" : m[2];
  };
  ...
  QZFL.media = {_tempImageList:[], _flashVersion:null, getImageInfo:function() {
    ...
    return function(callback, opts) {
      ...
      if (QZFL.lang.isString(opts.trueSrc)) {
        ...
        if (QZFL.lang.isElement(opts.img)) {
    ...
    if (QZFL.userAgent.ie) {
      if (QZFL.userAgent.ie > 10) {
        _attrs.push(' classid="clsid:', flashPlayerCID || "D27CDB6E-AE6D-11cf-96B8-444553540000", '"', ' data="', flashArguments.src || "", '"');
      } else {
  ...
  QZFL.widget.msgbox = {cssPath:"//" + QZFL.config.resourceDomain + "/ac/qzfl/release/css/msgbox.css", path:"//" + QZFL.config.resourceDomain + "/ac/qzfl/release/widget/msgbox.js", currentCssPath:null, _loadCss:function(s) {
  ...
  QZFL.dialog = {cssPath:"http://" + QZFL.config.resourceDomain + "/qzone_v6/qz_dialog.css", currentCssPath:"", path:"http://" + QZFL.config.resourceDomain + "/ac/qzfl/release/widget/dialog.js?max_age=864020", count:0, instances:{}, BUTTON_TYPE:{Disabled:-1, Normal:0, Cancel:1, Confirm:2, Negative:3}, create:function(title, content, opts) {
    var t, args, dialog;
  ...
  QZFL.maskLayout = function() {
    var masker = null, count = 0, qml = function(zi, doc, opts) {
      ...
      masker = QZFL.dom.createElementIn("div", doc.body, false, {className:"qz_mask", unselectable:"on", style:'-ms-filter:"progid:DXImageTransform.Microsoft.Alpha(opacity=20)"'});
  ...
  QZFL.widget.seed = {_seed:1, domain:"qzone.qq.com", prefix:"__Q_w_s_", update:function(k, opt) {
    ...
    if (typeof k == "undefined") {
      ...
      if (opt && opt.useCookie) {
        n = QZFL.cookie.get(k);
        if (n) {
          QZFL.cookie.set(k, ++n, opt.domain || th.domain, null, 3E3);
        } else {
          return 0;
        }
      } else {
    ...
    if (typeof k == "undefined") {
      ...
      k = th.prefix + k;
      if (opt && opt.useCookie) {
        return(n = QZFL.cookie.get(k)) ? n : (QZFL.cookie.set(k, n = 1, opt.domain || th.domain, null, 3E3), n);
      } else {
  ...
  QZFL.widget.runBox = function(startNode, endNode, opts) {
    ...
    QZFL.effect.run(dv, {left:ep.left, top:ep.top, width:ep.width, height:ep.height}, {duration:opts.duration * 1E3, complete:function() {
  ...
  function errcodeReport(params) {
    ...
    var data = {pathname:params.pathname, code:params.code, cgi:params.cgi};
    data = toUrlParam(data);
    if (XMLHttpRequest) {
      var xhr = new XMLHttpRequest;
      xhr.withCredentials = true;
      xhr.open("post", "//h5.qzone.qq.com/log/post/error/pc/" + lastSegments, true);
  ...
  function transUrl2HttpsIfNeed(ss, useSameProtocolOfPage) {
    ...
    if (sdms[uri.host] == 1) {
      ...
      if (uri.host == "qzonestyle.gtimg.cn" || (uri.host == "qzs.qq.com" || uri.host == "qzs.qzone.qq.com")) {
  ...
  (function(q) {
    ...
    var commurl = "https://huatuocode.weiyun.com/code.cgi", urlParse = /^https?:\/\/([\s\S]*?)(\/[\s\S]*?)(?:\?|$)/, pingSender = q.pingSender, collector = [], timer, hours = (new Date).getHours(), rateNumG = hours > 0 && hours < 8 ? 1 : 1, rateNumP = hours > 0 && hours < 8 ? 1 : 1, isreportG = function() {
      return Math.random() * rateNumG < 1;
    }, isreportP = function() {
      return Math.random() * rateNumP < 1;
    }, uin = typeof g_iUin == "undefined" ? 0 : g_iUin, duration = 1E3, each = q.object.each;
    function valueStat(domain, cgi, type, code, time, rate, uin, exts) {
      ...
      if (typeof exts.unshift == "function") {
        ...
        while (exts.length) {
          ...
          param.push([i + 1, 2].join("_") + "=" + c[1] + (c[6] ? "?qzfl_s" : "?qzfl"));
      ...
      if (domain != "" || i > 0) {
        q.pingSender && q.pingSender(commurl + "?" + param.join("&"), 1E3);
      }
    }
    function _r() {
      if (collector.length) {
    ...
    each(["JSONGetter", "FormSender"], function(n) {
      ...
      if (q[n] && q[n].pluginsPool) {
        ...
        q[n].pluginsPool.onRequestComplete.push(function(th) {
          ...
          if (d && (d = d[0])) {
            ...
            if (d.code != 0) {
              ...
              if (th && (th.ownerWindow && th instanceof th.ownerWindow.QZFL.FormSender)) {
                if (th.reportRate) {
        ...
        q[n].pluginsPool.onRequestComplete.push(function(th) {
          if (isspeedup && (th && (th.ownerWindow && th instanceof th.ownerWindow.QZFL.FormSender))) {
            var takes = th.postTime - th.startTime, s, fl3;
            if ((th._uri || th.uri).indexOf("taotao.qq.com") > -1) {
              fl3 = 51;
            } else {
              if ((th._uri || th.uri).indexOf("w.qzone.qq.com") > -1) {
                fl3 = 52;
              }
            }
            if (!fl3) {
  ...
  QZFL.config.xhrGetReqProxyEnable = function(url) {
    ...
    var sdms = QZFL.win.g_sdms || {};
    var mtches = url.match(urlParse), dm = mtches[1], cgi = mtches[2];
    if (sdms[dm] == 1 || dm == location.hostname) {
      return true;
    }
    return false;
  };
